...
EXERCISES = [
    {
        ...
        "description": "Movimiento base para piernas y gluteos. Mantiene la espalda neutra.",
    ...
    },
    {
        ...
        "description": "Intervalos cortos de alta intensidad para resistencia y perdida de grasa.",
        "place": Exercise.Place.GYM,
